...
/// <summary>
/// Class to perform unit tests of ConflictException class.
/// </summary>
[ExcludeFromCodeCoverage]
public class ConflictExceptionTest : xUnitTest<ConflictExceptionTestContext>
{
    /// <summary>
    ...
    /// Test context.
    /// </param>
    public ConflictExceptionTest(ConflictExceptionTestContext context) : base(context)
    {
    }
    ...
    public void Ctor_Success()
    {
        ...
        Assert.Equal("Exception of type 'Accelerate.ConflictException' was thrown.", exception.Message);
    ...
    public void Ctor_Success_With_Empty_Message_And_Not_Null_Exception()
    {
        ...
        var exception = new ConflictException(String.Empty, innerException);
        Assert.NotNull(exception);
        Assert.Equal(String.Empty, exception.Message);
    ...
    {
        var exception = new ConflictException(String.Empty, null);
        Assert.NotNull(exception);
        Assert.Equal(String.Empty, exception.Message);
        Assert.Null(exception.InnerException);
    }
    ...
    {
        var exception = new ConflictException("message of exception");
        Assert.NotNull(exception);
    ...
    {
        var innerException = new Exception();
        var exception = new ConflictException("message of exception", innerException);
        Assert.NotNull(exception);
        Assert.Equal("message of exception", exception.Message);
        Assert.NotNull(exception.InnerException);
    }
    ...
    {
        var exception = new ConflictException("message of exception", null);
        Assert.NotNull(exception);
        Assert.Equal("message of exception", exception.Message);
        Assert.Null(exception.InnerException);
    }
